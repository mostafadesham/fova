...
$microwallets = [
    ...
    'expresscrypto' => [ 
        'name' => 'ExpressCrypto',
        'currencies' => ['ADA','BCH','BCN','BNB','BTC','BTT','DASH','DGB','DOGE','ETC','ETH','EXG','EXS','KMD','LSK','LTC','NEO','PIVX','PPC','RDD','RVN','STRAX','TRX','USDT','VTC','WAVES','XMR','XRP','XTZ','ZEC','ZEN','SHIB'],
        'api_base' => 'https://expresscrypto.io/public-api/v2/',
        'check' => 'https://expresscrypto.io/dashboard',
        'url' => 'https://expresscrypto.io/signup?referral=292952',
    ...
    'faucetpay' => [
        'name' => 'FaucetPay',
        'currencies' => ['BCH','BNB','BTC','DASH','DGB','DOGE','ETH','FEY','LTC','TRX','USDT','ZEC','SOL'],
        'api_base' => 'https://faucetpay.io/api/v1/',
        'check' => 'https://faucetpay.io/page/user-admin',
        'url' => 'https://faucetpay.io/?r=320027'
    ],
