...
<html lang="en"> 
    <head>
        ...
        <title><?= ($settings['name'])?: 'VEGAFaucet Script';?> Admin Panel</title>
        <meta name="description" content="">
    	<meta name="keywords" content="">
    	<meta name="robots" content="noindex,nofollow">
    	<!-- FAUCET FAVICON -->
				  <link rel="icon" type="image/x-icon" href="https://i.ibb.co/HCrq9Jq/vegafaucet.png">
		<!-- Bootstrap
    ...
    <body class="d-flex flex-column">
    	...
    	<nav class="navbar navbar-expand-md navbar-dark bg-primary p-2">
			<div class="container">
                <a class="navbar-brand" href="<?= $settings['domain'];?>/admin/"><?= ($settings['name'])?: 'VEGAFaucet Script';?> Admin</a>
        ...
        <footer class="py-3">
            <div class=" text-center">
                <div class="col-12">
                  Copyright© 2020-<?= date('Y');?> <b>VEGAFaucet Script</b><br>
                    powered by <a href="https://gr8.cc" target="_blank">GR8 Faucet Script</a> for more features and improved security!<br>
                   More option and updates by <a href="https://7azemtn.blogspot.com/" target="_blank">7azemTN</a>
